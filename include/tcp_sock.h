...
#define TCP_MAX_BACKLOG 128
	...
	u32 dup_ack;
	// congestion avoidance ack counet
	u32 cong_avoid_ack; 
...
struct pended_packet
{
	struct list_head list; // List node
	char *packet; // Dumped packet
	u32 seq; // Sequence number
	u32 len; // Real packet length
	u32 seq_end; 
};
